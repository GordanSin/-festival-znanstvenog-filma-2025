    ...
    <section id="sponsors" className="py-12 bg-muted/10" data-testid="sponsors-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
          ...
          {/* Kino Pazin */}
          <div className="flex items-center justify-center" data-testid="sponsor-kino-pazin">
            <img 
              src={kinoPazinLogo} 
              alt="Kino Pazin logo" 
              className="w-32 h-auto object-contain opacity-80 hover:opacity-100 transition-opacity"
              loading="lazy"
            />
          </div>
        </div>
