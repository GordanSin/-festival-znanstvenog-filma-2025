        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/udrugatehnickekulture/" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors" data-testid="footer-social-facebook">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-primary-foreground/80">UTK-SCT "Galileo Galilei", Rovinj-Rovigno</li>
              <li className="text-primary-foreground/80">Goethe-Institut Kroatien</li>
            </ul>
          </div>
        </div>
